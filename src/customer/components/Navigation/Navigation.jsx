        ...
        >
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center">
              <button
                type="button"
                className="relative rounded-md bg-white p-2 text-gray-400 lg:hidden outline-none"
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  {true ? (
                    ...
                    <Button
                      className="text-sm font-medium text-gray-700 hover:text-gray-800 outline-none"
                      variant="outlined"
                      onClick={handleOpen}
                    >
                      Sign In
                ...
                <div className="ml-4 flow-root lg:ml-6">
                  <Button className="group -m-2 flex items-center p-2 outline-none">
                    <ShoppingBagIcon
