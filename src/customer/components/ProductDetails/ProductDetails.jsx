  ...
  return (
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-9 gap-t-10 pt-10 px-4">
          {/* Image gallery */}
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  <Rating
                    ...
                    precision={0.5}
                  />
                  <p className="opacity-50 text-sm">3456 Ratings</p>
              ...
              <Grid irem xs={5}>
                ...
                <div className="flex items-center space-x-3">
                  <Rating
                    ...
                    readOnly
                  />
                  <p className="opacity-60">35345 Ratings</p>
                </div>
